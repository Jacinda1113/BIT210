...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        VALUES ('$contributionID', '$date','CASH', '$amount', '$paymentMethod', '$referenceNo', '$appealID')";
...
<body>
            ...
            <div class="row align-items-center">
                <div class="card text-center w-50" id="notif">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-default btn-sm" id="notAdd" onclick="donateAgain()">Donate Again</button>
  ...
  <script>
    ...
    function donateAgain(){
        window.location.href = "currentAppeal.php";
    }
  </script>
</body>
