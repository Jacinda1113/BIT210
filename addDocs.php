    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($password == "null"){
            ...
            if(count($fetchResult) == 0){
                ...
                echo "<script>alert('ID Number Has Been Used');window.location.href='selfRegistration.php';</script>";
            }
        }
        $con->close();
    }
...
?>
  ...
  <script>
    ...
    function submitLastForm(){
        document.getElementById("documentForm").setAttribute('action', "lastDoc.php");
        document.getElementById("documentForm").submit();
    }
