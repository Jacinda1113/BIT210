...
<body>
  <div class="wrap">
    ...
    <section id="hero">
      <div class="hero-container" data-aos="fade-up">
        <h1>Let's spread kindness all over the world with <span>HELP Aid</span></h1>
        <h2>Noble deeds that are concealed are more esteemed</h2>
        <a href="currentAppeal.php" class="btn-get-started scrollto">Donate Now</a>
      </div>
    </section><!-- End Hero -->
    ...
    <main id="main">
      ...
      <section id="about" class="about">
        <div class="container">
          ...
          <div class="row">
            <div style="background-image: url(assets/img/hero_banner)" data-aos="fade-right" class="image col-xl-5 d-flex align-items-stretch justify-content-center justify-content-lg-start"></div>
            <div class="col-xl-7 pt-4 pt-lg-0 d-flex align-items-stretch">
              <div class="content d-flex flex-column justify-content-center" data-aos="fade-left">
                <h3>YOUR DONATION MATTERS FOR THEM</h3>
                <p>
      ...
      <!-- ======= Appeal Documentation Section ======= -->
      <div class="section-title" data-aos="fade-down">
        <span>Our Past Projects</span>
        <h2>Our Past Projects</h2>
      </div>
      <section id="appeals" class="appeals">
        <div class="container">
      ...
      </section><!-- End Appeal Documentation Section -->
    </main><!-- End #main -->
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>  <script src="https://cdn.jsdelivr.net/gh/mcstudios/glightbox/dist/js/glightbox.min.js"></script>
