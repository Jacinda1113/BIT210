...
include("dbcon.php");
    ...
    $aidStatus = "SELECT contribution.contributionID, contribution.appealID, disbursement.disbursementDate,disbursement.cashAmount, disbursement.goodsDisbursed, disbursement.status
     ...
     WHERE disbursement.status = 'Not Received'";
        ...
        <div class="container d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto " href="recordAppeal.php">Record New Appeal</a></li>
              <li><a class="nav-link scrollto " href="aidDisbursement.php">Record Aid Disbursement</a></li>
              <li><a class="nav-link scrollto " href="test.php">Package Status</a></li>
      ...
      <div class="breadcrumbs">
        <div class="container">
          ...
          <div class="navbar navbar-expand-lg navbar-expand-sm navbar-expand-md navbar-expand-xs navbar-light bg-light">
                <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="AidDelivered.php">Delivered</a>
                </li>
                <li class="nav-item">
                    <a class="active nav-link" href="NotDelivered.php">Not Delivered</a>
                </li>
                <li class="nav-item">
            ...
            <div>
                <div class="col">
                  ...
                  ?>
                    ...
                    <form method="get" action="aidDisbursement.php">
                        <button type="submit">Redisburse Aids</button>
                    </form>
                </div>
              </div>
          </div>
